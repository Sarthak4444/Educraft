      ...
      <div className="flex flex-col gap-6 self-stretch rounded-[14px] bg-[#FfFFff] px-3.5 py-[30px] sm:py-5">
        <div className="flex flex-col items-center gap-[18px]">
          ...
          <div className="flex flex-col items-center gap-2 self-stretch">
            ...
            <Heading
              as="p"
              classMame="self-stretch text-center text-[16px] font-normal leading-[30px] text-[#5d5a6f]"
            >
        ...
        <Button
          ...
          variant="outline"
          shape="round"
          className="mx-[50px] self-stretch rounded-[5px] border px-[20px] font-medium sm:px-5"
        >
          Class Details
        </Button>
      </div>
