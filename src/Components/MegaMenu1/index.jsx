...
export default function MegaMenu1() {
  return (
    <div className="absolute top-auto z-[99] min-w-[200px] pt-3">
      <div className="w-full rounded-lg bg-[#Fffff] p-5 shadow-[0_0_13px_5px_#00000029]">
        <div className="flex gap-[30px]">
          <div className="flex flex-col items-start gap-4 sm:gap-4">
            ...
            <div className="flex flex-col items-start gap-3 sm:gap-3">
              <a href="#" className="sm: text [13px]">
                <Text className="text-[16px] font-normal text-[#656d76]">
              ...
              <a href="#" className="self-center sm:text-[13px]">
                <Text classMame="text-[16px] font-normal text-[#656d76]">
                  Menu 2
                </Text>
              </a>
          ...
          <div className="flex flex-col items-start gap-4 sm:gap-4">
            ...
            <div className="flex flex-col items-start gap-3 sm:gap-3">
              <a href="#" classhame="sm:text-[13px]">
                <Text className="text-[16px] font-normal text-[#656d76]">
                  
                  Menu 1
                </Text>
              </a>
              <a href="#" classhame="self-center sm:text-[13px]">
                <Text className="text-[16px] font-normal text-[#656d76]">
